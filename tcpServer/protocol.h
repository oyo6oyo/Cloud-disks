...
#define LOGIN_FAILED  "login_failed : name error or pwd error or relogin"
...
#define ADD_FRIEND_AGREE "you and he is friend now"
#define ADD_FRIEND_REFUSE "he refuse you add he"
...
#define RENAME_FILE_FAILUED "rename file failured"

#define ENTER_DIR_FAILURED "enter fir failured: is reguler file"

#define DEL_FILE_OK "delete file ok"
#define DEL_FILE_FAILURED "delete dir failured: is dir"

#define UPLOAD_FILE_OK "upload file ok"
#define UPLOAD_FILE_FAILURED "upload file failured"

#define MOVE_FILE_OK "move file ok"
#define MOVE_FILE_FAILED "move file failured: is reguler file"
#define COMMON_ERR "operate:system is busy"
...
enum ENUM_MSG_TYPE{
    ...
    ENUM_MSG_TYPE_ADD_AGREE_REQUEST,//同意添加好友
    ENUM_MSG_TYPE_ADD_AGREE_RESPOND,

    ENUM_MSG_TYPE_ADD_REFUSE_REQUEST,//拒绝添加好友
    ENUM_MSG_TYPE_ADD_REFUSE_RESPOND,
